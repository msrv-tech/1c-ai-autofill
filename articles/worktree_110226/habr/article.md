...
![Голлум: «Моя прелесть — merge без конфликтов»](https://raw.githubusercontent.com/msrv-tech/1c-ai-autofill/main/articles/worktree_110226/media/gollum-merge.png)
...
Подробно (и тем же смыслом, но в формате «инструкции») это уже оформлено в репозитории: `docs/MERGE.md`.
