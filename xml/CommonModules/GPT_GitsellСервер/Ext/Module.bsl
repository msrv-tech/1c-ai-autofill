...
Процедура УстановитьРасширение(ДвоичныеДанные) Экспорт
	...
	ИмяРасширения = "GPT_ОписаниеНоменклатуры"; 
	...
	Иначе
		// Если вдруг расширение называется иначе или мы устанавливаем с нуля (странный кейс)
		Расширение = РасширенияКонфигурации.Создать();
		Расширение.Имя = ИмяРасширения;
		Расширение.Активно = Истина;
		Расширение.БезопасныйРежим = Ложь; 
		Расширение.Назначение = НазначениеРасширенияКонфигурации.Адаптация;
