...
// Описание:
// Обработчик завершения длительной операции генерации описания. Заполняет описание/комментарий и дополнительные свойства на форме.
// Параметры:
//   Результат - Результат длительной операции или Неопределено.
